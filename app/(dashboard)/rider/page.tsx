    ...
    <div className="min-h-screen overflow-x-hidden bg-[#fafafb] text-[#111827]">
      <header className="border-b border-[#eceff3] bg-white">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <label className="flex items-center gap-3 rounded-[8px] border border-[#eceff3] bg-white px-4 py-2.5">
              <span className="text-right">
                ...
                <span className="block text-[11px] text-muted-foreground">Open-pool offers</span>
              </span>
        ...
        <p className="mt-3 text-[13px] text-muted-foreground">
          ...
          {user?.riderWorkMode === "platform"
            ? " As a platform rider you can also receive delivery offers from any restaurant nearby, not just your own team."
            : ""}
        </p>
